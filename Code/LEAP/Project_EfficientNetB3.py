...
s = open("Output_EfficientNetB3.txt", "w")
...
EfficientNet = EfficientNetB3(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
plt.legend()
plt.savefig('Output_EfficientNetB3_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB3_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB3_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB3_Test_AUC_ROC.png')
plt.clf()
