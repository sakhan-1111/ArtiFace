...
s = open("Output_EfficientNetB2.txt", "w")
...
EfficientNet = EfficientNetB2(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
plt.legend()
plt.savefig('Output_EfficientNetB2_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB2_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB2_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB2_Test_AUC_ROC.png')
plt.clf()
