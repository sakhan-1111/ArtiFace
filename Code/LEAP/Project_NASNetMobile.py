...
s = open("Output_NASNetMobile.txt", "w")
...
NASNet = NASNetMobile(input_shape=(200, 200, 3), include_top = False, weights = 'imagenet')
NASNet.summary()
...
model.add(layers.Conv2D(1056, (3, 3), activation='relu'))
model.add(layers.Dropout(0.2))
model.add(layers.Flatten())
model.add(layers.Dense(1056, activation='relu'))
model.add(layers.Dropout(0.2))
...
plt.legend()
plt.savefig('Output_NASNetMobile_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_NASNetMobile_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_NASNetMobile_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_NASNetMobile_Test_AUC_ROC.png')
plt.clf()
