...
#
####################################################
print('Model = EfficientNetV2B2')

s = open("Output_EfficientNetV2B2.txt", "w")
...
EfficientNet = EfficientNetV2B2(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
model.add(layers.Conv2D(1408, (3, 3), activation='relu'))
...
model.save('EfficientNetV2B2.h5')
...
plt.legend()
plt.savefig('Output_EfficientNetV2B2_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetV2B2_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B2_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B2_Test_AUC_ROC.png')
plt.clf()
