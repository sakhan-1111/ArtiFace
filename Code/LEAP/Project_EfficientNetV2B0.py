...
s = open("Output_EfficientNetV2B0.txt", "w")
...
s.write('>> Creating the transfer learnig model...\n')
# The transfer learning model
EfficientNet = EfficientNetV2B0(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
plt.legend()
plt.savefig('Output_EfficientNetV2B0_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetV2B0_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B0_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B0_Test_AUC_ROC.png')
plt.clf()
