...
s = open("Output_EfficientNetV2B1.txt", "w")
...
EfficientNet = EfficientNetV2B1(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
model.save('EfficientNetV2B1.h5')
...
plt.legend()
plt.savefig('Output_EfficientNetV2B1_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetV2B1_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B1_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B1_Test_AUC_ROC.png')
plt.clf()
