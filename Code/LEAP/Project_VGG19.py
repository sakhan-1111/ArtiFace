...
plt.legend()
plt.savefig('Output_VGG19_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_VGG19_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_VGG19_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_VGG19_Test_AUC_ROC.png')
plt.clf()
