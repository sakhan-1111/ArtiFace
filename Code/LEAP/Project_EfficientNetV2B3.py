...
#
####################################################
print('Model = EfficientNetV2B3')

s = open("Output_EfficientNetV2B3.txt", "w")
...
EfficientNet = EfficientNetV2B3(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
# Remove layers
EfficientNet_2 = Model(EfficientNet.input, EfficientNet.layers[-2].output)
EfficientNet_2.summary()


# Make CNN Model
model = models.Sequential()
model.add(EfficientNet_2)
model.add(layers.MaxPooling2D((2, 2)))
model.add(layers.Conv2D(1536, (3, 3), activation='relu'))
...
model.save('EfficientNetV2B3.h5')
...
plt.legend()
plt.savefig('Output_EfficientNetV2B3_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetV2B3_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B3_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2B3_Test_AUC_ROC.png')
plt.clf()
