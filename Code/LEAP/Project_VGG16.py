...
# # Remove layers
# VGG_2 = Model(VGG.input, VGG.layers[-2].output)
# VGG_2.summary()
...
plt.legend()
plt.savefig('Output_VGG16_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_VGG16_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_VGG16_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_VGG16_Test_AUC_ROC.png')
plt.clf()
