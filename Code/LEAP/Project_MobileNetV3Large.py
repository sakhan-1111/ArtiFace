...
s = open("Output_MobileNetV3Large.txt", "w")
...
MobileNetV3 = MobileNetV3Large(input_shape=(200, 200, 3), include_top = False, 
...
plt.legend()
plt.savefig('Output_MobileNetV3Large_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_MobileNetV3Large_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_MobileNetV3Large_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_MobileNetV3Large_Test_AUC_ROC.png')
plt.clf()
