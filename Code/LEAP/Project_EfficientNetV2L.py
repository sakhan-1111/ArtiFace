...
s = open("Output_EfficientNetV2L.txt", "w")
...
EfficientNet = EfficientNetV2L(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
plt.legend()
plt.savefig('Output_EfficientNetV2L_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetV2L_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2L_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetV2L_Test_AUC_ROC.png')
plt.clf()
