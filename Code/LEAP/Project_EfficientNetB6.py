...
#
####################################################
print('Model = EfficientNetB6')

s = open("Output_EfficientNetB6.txt", "w")
...
EfficientNet = EfficientNetB6(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
model.add(layers.Conv2D(2304, (3, 3), activation='relu'))
...
plt.legend()
plt.savefig('Output_EfficientNetB6_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB6_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB6_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB6_Test_AUC_ROC.png')
plt.clf()
