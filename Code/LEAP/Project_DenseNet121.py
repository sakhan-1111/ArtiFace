...
s = open("Output_DenseNet121.txt", "w")
...
DenseNet = DenseNet121(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
DenseNet.summary()
...
plt.legend()
plt.savefig('Output_DenseNet121_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_DenseNet121_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_DenseNet121_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_DenseNet121_Test_AUC_ROC.png')
plt.clf()
