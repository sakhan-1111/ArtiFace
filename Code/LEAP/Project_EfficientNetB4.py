...
s = open("Output_EfficientNetB4.txt", "w")
...
EfficientNet = EfficientNetB4(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
model.add(layers.Conv2D(1792, (3, 3), activation='relu'))
model.add(layers.Dropout(0.2))
model.add(layers.Flatten())
model.add(layers.Dense(1792, activation='relu'))
model.add(layers.Dropout(0.2))
...
plt.legend()
plt.savefig('Output_EfficientNetB4_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB4_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB4_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB4_Test_AUC_ROC.png')
plt.clf()
