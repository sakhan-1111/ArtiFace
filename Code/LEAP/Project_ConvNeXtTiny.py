...
s = open("Output_ConvNeXtTiny.txt", "w")
...
ConvNeXt = ConvNeXtTiny(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
ConvNeXt.summary()
...
plt.legend()
plt.savefig('Output_ConvNeXtTiny_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_ConvNeXtTiny_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtTiny_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtTiny_Test_AUC_ROC.png')
plt.clf()
