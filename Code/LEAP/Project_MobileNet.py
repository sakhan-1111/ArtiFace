...
MobileNet = MobileNet(input_shape=(200, 200, 3), include_top = False, weights = 'imagenet')
MobileNet.summary()
...
plt.legend()
plt.savefig('Output_MobileNet_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_MobileNet_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_MobileNet_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_MobileNet_Test_AUC_ROC.png')
plt.clf()
