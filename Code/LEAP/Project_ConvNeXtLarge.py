...
#
####################################################
print('Model = ConvNeXtLarge')

s = open("Output_ConvNeXtLarge.txt", "w")
...
ConvNeXt = ConvNeXtLarge(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
ConvNeXt.summary()
...
# Remove layers
ConvNeXt_2 = Model(ConvNeXt.input, ConvNeXt.layers[-4].output)
ConvNeXt_2.summary()


# Make CNN Model
model = models.Sequential()
model.add(ConvNeXt_2)
...
plt.legend()
plt.savefig('Output_ConvNeXtLarge_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_ConvNeXtLarge_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtLarge_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtLarge_Test_AUC_ROC.png')
plt.clf()
