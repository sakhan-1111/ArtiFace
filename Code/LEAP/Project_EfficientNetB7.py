...
#
####################################################
print('Model = EfficientNetB7')

s = open("Output_EfficientNetB7.txt", "w")
...
EfficientNet = EfficientNetB7(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
model.add(layers.Conv2D(2560, (3, 3), activation='relu'))
...
plt.legend()
plt.savefig('Output_EfficientNetB7_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB7_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB7_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB7_Test_AUC_ROC.png')
plt.clf()
