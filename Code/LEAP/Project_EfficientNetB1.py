...
#
####################################################
print('Model = EfficientNetB1')

s = open("Output_EfficientNetB1.txt", "w")
...
EfficientNet = EfficientNetB1(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
...
plt.legend()
plt.savefig('Output_EfficientNetB1_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_EfficientNetB1_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB1_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_EfficientNetB1_Test_AUC_ROC.png')
plt.clf()
