...
#
####################################################
print('Model = ConvNeXtSmall')

s = open("Output_ConvNeXtSmall.txt", "w")
...
ConvNeXt = ConvNeXtSmall(include_top=False, weights='imagenet', input_shape=(200, 200, 3))
ConvNeXt.summary()
...
plt.legend()
plt.savefig('Output_ConvNeXtSmall_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_ConvNeXtSmall_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtSmall_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_ConvNeXtSmall_Test_AUC_ROC.png')
plt.clf()
