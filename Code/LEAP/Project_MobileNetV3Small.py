...
s = open("Output_MobileNetV3Small.txt", "w")
...
MobileNetV3 = MobileNetV3Small(input_shape=(200, 200, 3), include_top = False, 
...
# # Remove layers
# MobileNetV3_2 = Model(MobileNetV3.input, MobileNetV3.layers[-5].output)
# MobileNetV3_2.summary()
...
model.add(layers.Conv2D(576, (3, 3), activation='relu'))
...
plt.legend()
plt.savefig('Output_MobileNetV3Small_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_MobileNetV3Small_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_MobileNetV3Small_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_MobileNetV3Small_Test_AUC_ROC.png')
plt.clf()
