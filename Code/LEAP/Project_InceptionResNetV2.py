...
s = open("Output_InceptionResNetV2.txt", "w")
...
InceptionResNet = InceptionResNetV2(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
...
# Remove layers
InceptionResNet_2 = Model(InceptionResNet.input, InceptionResNet.layers[-2].output)
InceptionResNet_2.summary()


# Make CNN Model
model = models.Sequential()
model.add(InceptionResNet_2)
model.add(layers.MaxPooling2D((2, 2)))
model.add(layers.Conv2D(1536, (3, 3), activation='relu', padding='same'))
...
plt.legend()
plt.savefig('Output_InceptionResNetV2_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_InceptionResNetV2_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_InceptionResNetV2_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_InceptionResNetV2_Test_AUC_ROC.png')
plt.clf()
