...
ResNet = ResNet101(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
ResNet.summary()
...
plt.legend()
plt.savefig('Output_ResNet101_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_ResNet101_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_ResNet101_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_ResNet101_Test_AUC_ROC.png')
plt.clf()
