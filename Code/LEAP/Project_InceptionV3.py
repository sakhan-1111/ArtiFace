...
s = open("Output_InceptionV3.txt", "w")
...
# # Remove layers
# Inception_2 = Model(Inception.input, Inception.layers[-1].output)
# Inception_2.summary()
...
plt.legend()
plt.savefig('Output_InceptionV3_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_InceptionV3_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_InceptionV3_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_InceptionV3_Test_AUC_ROC.png')
plt.clf()
