...
Xcep = Xception(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
Xcep.summary()
...
# Remove layers
Xcep_2 = Model(Xcep.input, Xcep.layers[-2].output)
Xcep_2.summary()
...
plt.legend()
plt.savefig('Output_Xception_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_Xception_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_Xception_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_Xception_Test_AUC_ROC.png')
plt.clf()
