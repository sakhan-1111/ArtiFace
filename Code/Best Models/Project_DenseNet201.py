...
s = open("Output_DenseNet201.txt", "w")
...
DenseNet = DenseNet201(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
DenseNet.summary()
...
model.add(layers.Conv2D(1920, (3, 3), activation='relu'))
...
plt.legend()
plt.savefig('Output_DenseNet201_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_DenseNet201_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_DenseNet201_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_DenseNet201_Test_AUC_ROC.png')
plt.clf()
