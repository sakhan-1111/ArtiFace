...
#
####################################################
print('Model = NASNetLarge')

s = open("Output_NASNetLarge.txt", "w")
...
NASNet = NASNetLarge(input_shape=(200, 200, 3), include_top = False, weights = 'imagenet')
NASNet.summary()
...
# Remove layers
NASNet_2 = Model(NASNet.input, NASNet.layers[-2].output)
NASNet_2.summary()
...
model.add(layers.Conv2D(4032, (3, 3), activation='relu'))
model.add(layers.Dropout(0.2))
model.add(layers.Flatten())
model.add(layers.Dense(4032, activation='relu'))
model.add(layers.Dropout(0.2))
...
plt.legend()
plt.savefig('Output_NASNetLarge_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_NASNetLarge_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_NASNetLarge_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_NASNetLarge_Test_AUC_ROC.png')
plt.clf()
