...
s = open("Output_ResNet101V2.txt", "w")
...
ResNet = ResNet101V2(include_top = False, weights = 'imagenet', input_shape=(200, 200, 3))
ResNet.summary()
...
plt.legend()
plt.savefig('Output_ResNet101V2_Training_and_validation_accuracy.png')
plt.clf()
...
plt.legend()
plt.savefig('Output_ResNet101V2_Training_and_validation_loss.png')
plt.clf()
...
plt.savefig('Output_ResNet101V2_Test_Confusion_Matrix.png')
plt.clf()
...
plt.savefig('Output_ResNet101V2_Test_AUC_ROC.png')
plt.clf()
